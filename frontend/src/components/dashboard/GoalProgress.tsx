  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-5">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-xs text-gray-400 ml-auto">By Dec 2026</span>
      </div>
      ...
      <div className="mb-4">
        ...
        <p className="text-xs text-gray-400 mt-1">{Math.round(bfProgress)}% of the way there</p>
      </div>
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1">{Math.round(vo2Progress)}% of the way there</p>
      </div>
    </div>
  );
}
