...
### Recovery Status
[Resting HR trends, body battery, training load vs recovery]
...
**For sleep, steps, and resting HR: reference the 30-day averages, last-7-day averages, and trends (improving/stable/declining). Call out specific patterns — e.g., how many nights were below target, whether resting HR is tracking recovery, whether steps are consistently below goal.**
